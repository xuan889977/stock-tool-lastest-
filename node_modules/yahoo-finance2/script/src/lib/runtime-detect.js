...
const runtimeGlobal_js_1 = require("./runtimeGlobal.js");
/** Detect the current JS runtime and version (if available). */
function detectRuntime() {
    const info = { runtime: "unknown", version: null, details: {} };
    const deno = (0, runtimeGlobal_js_1.getGlobalValue)("Deno");
    const proc = (0, runtimeGlobal_js_1.getGlobalValue)("process");
    const bun = (0, runtimeGlobal_js_1.getGlobalValue)("Bun");
    ...
    const navigator = (0, runtimeGlobal_js_1.getGlobalValue)("navigator");
    ...
    if (/Cloudflare-Workers/i.test(ua)) {
        ...
        info.details = {
            userAgent: ua,
            miniflare: !!(0, runtimeGlobal_js_1.getGlobalValue)("MINIFLARE") || /Miniflare/i.test(ua),
            hasWebSocketPair: typeof (0, runtimeGlobal_js_1.getGlobalValue)("WebSocketPair") !== "undefined",
            hasCaches: typeof (0, runtimeGlobal_js_1.getGlobalValue)("caches") !== "undefined",
        };
        return info;
    }
    if (typeof (0, runtimeGlobal_js_1.getGlobalValue)("process") === "undefined" &&
        typeof (0, runtimeGlobal_js_1.getGlobalValue)("Deno") === "undefined" &&
        typeof (0, runtimeGlobal_js_1.getGlobalValue)("Bun") === "undefined" &&
        typeof (0, runtimeGlobal_js_1.getGlobalValue)("WebSocketPair") !== "undefined" &&
        typeof (0, runtimeGlobal_js_1.getGlobalValue)("caches") !== "undefined") {
        info.runtime = "cloudflare";
        info.version = null;
...
function checkSupport(policy = {}) {
    ...
    const hasGlobalPath = (path) => {
        ...
        let cur = (0, runtimeGlobal_js_1.getRuntimeGlobal)();
